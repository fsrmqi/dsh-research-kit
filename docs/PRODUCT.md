...
工作流按流程族分 24 个类目（论文与手稿、文献研究、数据分析、基因组学、临床研究、生态学、天文与空间科学等，明细见 [README「目录内容」](../README.md#目录内容)），数据源按 11 个研究入口分组（文献与引文、临床与公共卫生、基因组与遗传变异、组学与表达数据、蛋白质/结构/通路、化学/药物/毒理、天文与空间科学、生物多样性与生态、气候/地球/环境、地理空间与社会数据、材料与物理科学，另有兜底组「其他研究数据源」）。目录规模以质量优先，不以数量为目标。
