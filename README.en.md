...
> A catalog and launcher for research workflows in DeepSeek Harness: 308 human-reviewed workflows, 23 skill-guidance modules, 122 scientific data sources.
...
```text
Research capability catalog (453 entries)
  → pick a workflow
...
1. Open the Research Workbench in a session — it lands on "Resources & Workflows"; search or filter the 453 catalog entries;
...
Plus 23 skills (`catalog/skills/`: core 20 / crop-breeding 2 / bioinformatics 1) and 122 database entries (`catalog/resources/`: crop-breeding 7 / literature 19 / genomics 8 / omics 7 / general-science 81). Full definitions live in [`catalog/`](catalog/); the data contract is in [architecture §4](docs/ARCHITECTURE.md).
